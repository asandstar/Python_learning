...
print("{:<{}} {:<{}} {:<{}}".format( 'Data Size:', stu.shape ))
...
print("{:<{}} {:<{}} {:<{}}".format( 'Data Size after drop:', stu.shape ))
#查看哪些列还有缺失数据
#print( "Nan Columns:\n",stu.isnull().any() )
print("{:<{}} {:<{}} {:<{}}".format( "Nan Columns:\n",stu.isnull().any() ))
...
print("{:<{}} {:<{}} {:<{}}".format("Excellent: {}, Fail: {}".format(ex,fail)))
